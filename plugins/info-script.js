...
const handler = async (m, { conn, args }) => {
   const res = await fetch('https://api.github.com/repos/nicoTK1/NicoBotLite-MD');
   const json = await res.json();
   let txt = `           *🧸 𝗕𝗼𝘁 - 𝗦𝗰𝗿𝗶𝗽𝘁 📍*\n\n`;
      txt += `◦  *𝐑𝐞𝐩𝐨:* ${json?.name || '🧸 𝙉𝙞𝙘𝙤𝘽𝙤𝙩𝙇𝙞𝙩𝙚-𝙈𝘿'}\n`;
      ...
      txt += `◦  *Url:* ${json?.html_url || 'https://github.com/nicoTK1/NicoBotLite-MD'}\n\n`;
